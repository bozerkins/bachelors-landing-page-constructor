var PleaseWait = new function () {
	...
	this.getPleaseWaitContainer = function() {
		...
		container = $('<div style="display: none; width: 100%; height: 100%; position: fixed; top: 0; left: 0;background: rgba(192,192,192,.2);z-index: 99999;" class="' + containerCalss + '"></div>');
		container.append($('<img style="display: none;position: fixed;top:5px; right: 5px;z-index: 900;" class="' + containerCalss + '" src="' + loadingImageSrc + '" alt="Loading...">'));
		container.append($('<div style="display: none;position: fixed; width: 300px; top: 50%; left: 50%;margin-left: -150px;text-align: center;" class="' + loadingTextClass + '"></div>'));
